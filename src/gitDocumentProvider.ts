...
export function uriForRef(repoRoot: string, ref: string, relativePath: string): vscode.Uri {
...
function parseDiffUri(uri: vscode.Uri): { ref: string; repoRoot: string; relativePath: string } | null {
